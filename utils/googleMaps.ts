  ...
  return new Promise((resolve, reject) => {
    ensureGoogleMapsLoaded()
      .then(() => {
        ...
        const destLatLng = new window.google.maps.LatLng(destination.latitude, destination.longitude);
...
export const calculateETA = (
  ...
  // Return a default value for native platforms
  if (Platform.OS !== 'web') {
    return Promise.reject(new Error('ETA calculation not available on native platforms'));
  }
...
export const getDirections = (
  ...
  // Return a default value for native platforms
  if (Platform.OS !== 'web') {
    return Promise.reject(new Error('Directions not available on native platforms'));
  }
