...
export default function SplashScreenComponent() {
  ...
  useEffect(() => {
    ...
    fadeAnimationRef.current = Animated.timing(fadeAnim, {
      toValue: 1,
      duration: 800,
      useNativeDriver,
    });

    logoAnimationRef.current = Animated.sequence([
    ...
    const checkAuthState = async () => {
      ...
      try {
        ...
        // Step 3: Wait for auth initialization and check authentication status
